...
state_dict = torch.load(
   '/work/pi_csc592_uri_edu/hafija_uri/DAST/pretrained/net_m.pth')
...
if opt.mode == 'black':
    ...
    state_dict = torch.load(
       '/work/pi_csc592_uri_edu/hafija_uri/DAST/pretrained/net_l.pth')
    ...
    attack_net = Net_l().to(device)
    state_dict = torch.load(
       '/work/pi_csc592_uri_edu/hafija_uri/DAST/saved_model/netD_epoch_49.pth')
