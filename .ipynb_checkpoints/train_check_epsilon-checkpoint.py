...
# Configuration
# -----------------------------
model_name = 'VGG16'  # Choose model variant: VGG11, VGG13, VGG16, VGG19
...
# Test/validation data normalization (no augmentation)
...
# Print the min and max values for sanity checking normalization
...
# -----------------------------
model = VGG(model_name).to(device)                  # Load VGG model (custom)
